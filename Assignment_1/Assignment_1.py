...
ap_df['avg_income'] = np.log10(ap_df['avg_income']) ### Log Transformation
ap_df['distance'] = np.log10(ap_df['distance']) ### Log transformation
...
ap_df = ap_df.drop(columns=['avg_income']) ### Highest VIF value
...
ap_df = ap_df.drop(columns=['distance']) ### Highest VIF value
...
ap_X_train, ap_X_val, ap_y_train, ap_y_val = train_test_split(ap_df.drop(columns=['Enroll']),ap_df['Enroll'], test_size=0.2,random_state=0)
...
ap_X_train, ap_X_val, ap_y_train, ap_y_val = train_test_split(ap_df_tree.drop(columns=['Enroll']),ap_df_tree['Enroll'], test_size=0.2,random_state=0)
